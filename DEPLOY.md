# Cloudflare Pages 部署指南 - 2026WBC_Tokyo-ai

## 專案設定

- **專案名稱**: 2026WBC_Tokyo-ai
- **建置指令**: `npm run build`
- **輸出目錄**: `dist`
...
# 建立 Pages 專案（若尚未建立）
npx wrangler pages project create 2026WBC_Tokyo-ai

# 建置並部署
npm run build
npx wrangler pages deploy dist --project-name=2026WBC_Tokyo-ai
```
...
1. 前往 **Workers & Pages** → 選擇 **2026WBC_Tokyo-ai**
...
```bash
# 設定 Production 環境
npx wrangler pages secret put GEMINI_API_KEY --project-name=2026WBC_Tokyo-ai
...
npm run build
npx wrangler pages dev dist --project-name=2026WBC_Tokyo-ai
